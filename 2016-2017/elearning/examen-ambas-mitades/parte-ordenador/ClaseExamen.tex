...
\pregunta{Crea una página HTML que se modifique con CSS y que contenga los siguientes
elementos
\begin{itemize}
...
\item{Crea una tabla de 3 filas y 4 columnas. Dentro de cada celda puedes escribir cualquier cosa. Usando CSS y la técnica que prefieras modifica el fondo de las celdas de la columna que quieras}
\end{itemize}
}{2}
\break
\pregunta{Dado el archivo XML que se puede encontrar a continuación, 
