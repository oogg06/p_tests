...
\pregunta{Unos programadores necesitan estructurar la información que intercambiarán los ficheros de sus aplicaciones para lo cual han determinado los requisitos siguientes que quieren plasmar en una DTD:}{4}
\begin{itemize}
...
\pregunta{Repetir el mismo ejercicio anterior pero creando un esquema XML. Se repiten a continuación los requisitos}{6}
\begin{itemize}
\item{    La raíz se llama {\tt listafacturas}.}
\item{    Dentro de la lista debe haber uno o más elementos {\tt factura}.}
\item{    Las facturas tienen un atributo {\tt fecha} que es optativo.}
