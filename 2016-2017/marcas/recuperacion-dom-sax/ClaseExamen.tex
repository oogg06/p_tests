...
\pregunta{Usando DOM procesar el fichero XML que se proporciona al final y averigue cuantos futuros hay cuya ciudad de procedencia sea Madrid y cuantos bonos hay cuyo precio SÍ sea estable. El programa deberá decirnos cual de las dos cantidades es mayor. Puedes utilizar la clase Java proporcionada y añadirle los métodos o código que desees. No hace falta que copies el código que ya se te proporciona.}{6.5}

\pregunta{Usando SAX procesar el mismo fichero y comprobar si hay algún bono cuya ciudad de procedencia sea ``Tokio'' y tengan un valor minimo de 9000 o más. Puedes utilizar la clase Java proporcionada y añadirle los métodos o código que desees. No hace falta que copies el código que ya se te proporciona.}{3.5}
