...
crear una hoja de estilo XSLT que transforme dicho archivo en el archivo XML que aparece al final. Observa que en el resultado solo aparecerá un producto {\bf si está en el edificio A}
}{3.5}
\begin{verbatim}
