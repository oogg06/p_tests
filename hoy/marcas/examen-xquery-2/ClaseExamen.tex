...
\pregunta{Averiguar qué números de proyecto tienen una media de cantidad suministradada mayor que la media global de cantidades suministradas. El resultado son varias filas.}{2}
\pregunta{Recuperar los tríos ``numero de proveedor'', ``numero de parte'', ``número de proyecto'' en los que sus tres ciudades sean distintos}{1}
\pregunta{Recuperar la cantidad de proveedores cuya ciudad es París o su estado es igual o mayor que 20.}{1}


\pregunta{Averiguar la media de cantidades suministrada para proyectos cuya ciudad sea ``París''. El resultado son varias filas}{1}
