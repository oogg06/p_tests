...
\begin{itemize}
\item{    El elemento raíz se llama ``proveedores''}
\item{    Dentro de él debe haber uno o más elementos ``proveedor''. Tiene siempre un atributo código formado por 3 mayúsculas, seguidas de un guión seguido de 3 cifras.}
\item{  Dentro de proveedor debe haber un elemento nombre dentro del cual habrá cadenas.}
\item{  Despues del proveedor hay siempre un elemento ubicacion y dentro de ubicación hay siempre un atributo país}
\item{  Despues hay un elemento credito, que es obligatorio. Dentro de él puede haber o no un atributo divisa que solo acepta los valores ``euro'' o ``dolar''. Dentro de credito siempre hay un entero positivo.}
...
<proveedores>
    ...
    <proveedor codigo="AAA-333">
        ...
        <nombre>TESA</nombre>
        <!--El atributo país es obligatorio-->
