...
\pregunta{Usando Java y las clases DOM del W3C mostrar el código de los proyectos que han recibido más de 300 partes p1 (solo se necesita examinar la tabla Suministra.)}{5}
