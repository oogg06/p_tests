...
\pregunta{Recuperar el recuento de proveedores cuya ciudad es París o su estado es igual o mayor que 20.}{1}
...
\pregunta{Indicar los códigos de proyecto que estén en la misma ciudad que otro proyecto}{2}
