...
\pregunta{Devolver cuantos proyectos reciben algún suministro que tenga en cantidad un valor de 650 o más. Debe salir un solo resultado.}{2}
\pregunta{Devolver el código de parte y el código de proyecto de la tabla suministra en la que la cantidad sea 300 o menos y además el proveedor sea v1 o v2.}{1}
...
\pregunta{Devolver los números de parte y el color de las partes cuyo color sea Azul.}{1}
