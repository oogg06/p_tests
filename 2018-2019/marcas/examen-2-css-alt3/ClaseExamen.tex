...
\item{Se ha modificado el espacio que hay entre el borde de las cajas y el texto interno, en concreto se
...
\item{Las cajas llevan el texto justificado, pero los elementos {\tt h1} de todas las cajas van en negrita y además el texto de dichos h1 va centrado.}
\item{Recuerda que puedes cambiar el HTML.}
\end{itemize}
...
\begin{itemize}
\item{Recuerda que puedes modificar el orden.}
...
\item{En pantallas pequeñas:}
    ...
    \item{Se ha decidido usar un posicionamiento con rejillas pero no nos han proporcionado las posiciones, ya que pueden verse a simple vista}
    \item{Se ha cambiado la distancia entre cada caja con respecto a su parte de arriba en 15px.}
    \item{La caja 3 tiene sus textos en cursiva. Las cajas 2 y 4 tienen un ancho distinto al de las cajas 1 y 5.}
    \end{itemize}
...
\begin{figure}[h]
    ...
    \label{figura31}
    \includegraphics[width=0.6\linewidth]{ej31.png}
\end{figure}
