...
\item{Los h1 de las cajas 4 y 5 están centrados y dichos h1 también tienen un fondo distinto.}
...
\item{Recuerda que los márgenes y espacios son aproximados, si calculas
por ejemplo un porcentaje de 20 y finalmente fuese 30 esto no perjudica
tu nota. Sin embargo, si hay algún espacio, margen, caja mal posicionada
o zona en blanco en la imagen y tu CSS no lo refleja de ninguna forma esto sí restará}
\end{itemize}
...
\item{Observa que algunos h1 están tachados.}
